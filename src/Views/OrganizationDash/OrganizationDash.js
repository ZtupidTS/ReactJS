...
class OrganizationDash extends React.Component  {
      ...
      >
        ...
        >
         ...
         <Grid
          ...
          xs={12}
        >
          <Link to="/instilist" style={{textDecorationLine:'none'}}>
            <Card className={classes.card}>
                  <CardMedia>
                    <InstituteIcon style={{fontSize:100}} color="primary"/>
                  </CardMedia>
                  <CardContent className={classes.cardContent}>
                    <Typography gutterBottom variant="h5"  component="h2">
                      Institute
                    ...
                    <Typography >
                      See relevant insights about your Institute
                    </Typography>
                  </CardContent>
        ...
        <Grid
          ...
          xs={12}
        >
          <Link to="/stafflist" style={{textDecorationLine:'none'}}>
            <Card className={classes.card}>
                  <CardMedia>
                  ...
                  <CardContent className={classes.cardContent}>
                    ...
                    <Typography >
                      See relevant insights about your Staff
                    </Typography>
                  </CardContent>
...
export default withStyles(styles) (OrganizationDash);